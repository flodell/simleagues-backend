# Generated by Django 6.0.1 on 2026-05-12 14:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("racing_number", models.IntegerField(blank=True, null=True)),
                (
                    "status",
                    models.CharField(
                        choices=[
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(
                    ("championship_entry__isnull", True), ("team__isnull", False)
                ),
                fields=("race", "team"),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(
                    ("championship_entry__isnull", True), ("user__isnull", False)
                ),
                fields=("race", "user"),
        ...
        migrations.AddConstraint(
            model_name="championshipentry",
            constraint=models.UniqueConstraint(
                condition=models.Q(("team__isnull", True), ("user__isnull", False)),
